...
export const rhodesIslandUpgradeOptionsData = {
  tier1: [
    ...
    { id: "rhodes-tier1-cross-domain-card", action: "domain-card", label: "技艺交流：从你不具有的领域中选择一张等级小于或等于你干员等级一半的领域卡（最高为2级）", doubleBox: true, boxCount: 2, stateIndex: 8, domainLevelCap: 2 },
  ...
  tier2: [
    ...
    { id: "rhodes-tier2-cross-domain-card", action: "domain-card", label: "技艺交流：从你不具有的领域中选择一张等级小于或等于你干员等级一半的领域卡（最高为4级）", doubleBox: true, boxCount: 2, stateIndex: 9, domainLevelCap: 4 },
  ...
  tier3: [
    ...
    { id: "rhodes-tier3-cross-domain-card", action: "domain-card", label: "技艺交流：从你不具有的领域中选择一张等级小于或等于你干员等级一半的领域卡（最高为5级）", doubleBox: true, boxCount: 2, stateIndex: 8, domainLevelCap: 5 },
    { id: "rhodes-tier3-proficiency", action: "proficiency", label: "实战模拟：熟练值+1", doubleBox: true, boxCount: 2, stateIndex: 7 },
    { id: "rhodes-tier3-module", action: "select-module", label: "所选模组器：", doubleBox: false, boxCount: 1, stateIndex: 6 },
  ],
